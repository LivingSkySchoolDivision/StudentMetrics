...
public partial class Graphs_AverageAttendanceRates : System.Web.UI.Page
{
    ...
    {
        AverageAttendanceRateGraph graph = new AverageAttendanceRateGraph(Config.dbConnectionString, DateTime.Now.AddDays(-30), DateTime.Now, "Average Attendance Rates");
